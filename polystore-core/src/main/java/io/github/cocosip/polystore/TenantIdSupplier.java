 ...
 *
 * <p>Resolution priority: {@link StorageSaveOptions#getTenantId()} (explicit) &gt;
 * {@code TenantIdSupplier} (implicit) &gt; {@code null}. A final {@code null} is fine for
 * {@link TenantIsolationMode#NONE}, but raises {@code TenantIdMissingException} under
 * {@link TenantIsolationMode#PATH_PREFIX}.</p>
 */
@FunctionalInterface
